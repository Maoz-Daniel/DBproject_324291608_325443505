...
בעת ביצוע שינוי (כגון `UPDATE`) בטבלה, ניתן לשמור את השינוי לצמיתות בבסיס הנתונים באמצעות הפקודה `COMMIT`.  
עד להרצת `COMMIT`, השינויים אינם מחייבים וניתן לבטל אותם באמצעות `ROLLBACK`.  

...
[קובץ CSV של מכשירי גישה (accessDevice)](data/csv/accessDevice/accessDevice.csv)
[קובץ CSV של תיקונים (repair)](data/csv/repair/repair.csv)
[קובץ CSV של אזורים (zone)](data/csv/zone/zone.csv)

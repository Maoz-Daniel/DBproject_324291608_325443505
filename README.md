...
להלן מספר שאילתות שבוצעו, יחד עם תיאור מטרתן, הקובץ שבו הן כתובות, ותמונה שמציגה את הפלט או את התוצאה הוויזואלית של השאילתה.
...
####  שאילתה 3: סיכום כניסות לפי חדר כושר ולפי חודש (בשנת 2025)

-  קובץ השאילתה: [query_3.sql](Stage_B/Queries/query_3/query_3.sql)  
-  תוצאת השאילתה:  
